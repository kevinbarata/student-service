...
import com.project.student.service.EmailSenderService;
import com.project.student.util.ErrorCodeEnum;
import com.project.student.util.RandomNumberGenerator;
    ...
    public ResponseEntityDto request(@RequestBody AuthDto authDto) {
        ...
        if (authDto != null){
            ...
            EmailDetails emailDetails = new EmailDetails();
                Date today = new Date();
            emailDetails.setSubject(authDto.getType() + " Student Management System "+ today);
            ...
            String htmlMsg = "<p style='margin:5px 0;font-weight:400;font-size:16pt;'>This is your code :</p>";
                ...
                htmlMsg += "<p style='margin:5px 0 15px;'>- Student Authentication System -</p>";
